...
- **音频可视化 1.1.1**：提供经典频谱、律动音柱、镜像光谱、柔波曲线、环形脉冲、星点跃动六种样式，播放详情页和桌面歌词可分别选择、开关。1.1.1 加粗环形脉冲的音柱，粗细随环形尺寸调整。
...
可视化测试还验证从 1.0.0 更新到当前版本、六种样式预览与绘制、主界面和桌面歌词分别保存及同步、键盘操作和关闭预览后释放分析器。
